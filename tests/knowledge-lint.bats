#!/usr/bin/env bats
#
# Scenario: the second brain (docs/knowledge/; Part A of PR #18's design, implementation
# spec at .temper/specs/second-brain-and-sdlc-extension/) stays small and internally
# consistent. tools/knowledge-lint.sh is the FAST gate
